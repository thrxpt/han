...
const translations = {
  th: {
    ...
    splitModeLabel: "แบ่งยังไงดี ?",
    splitEqual: "หารเท่ากัน",
    splitCustom: "กำหนดเอง",
    remaining: "เหลืออีก",
    overBy: "เกินมา",
    balancedOk: "ครบพอดี ✓",
    personShort: "คนที่ ",
    unbalancedHint: "ยอดยังไม่ครบ ปรับตัวเลขให้พอดีก่อนนะ",
    shareAmountAria: "จำนวนของคนที่",
    unitToggleAria: "สลับหน่วย % / ฿",
  },
  en: {
    ...
    remaining: "Remaining",
    overBy: "Over by",
    balancedOk: "All balanced ✓",
    personShort: "P",
    unbalancedHint: "Amounts don't add up yet — balance them to show the QR",
    shareAmountAria: "Share for person",
    unitToggleAria: "Toggle unit % / ฿",
  },
} as const;
